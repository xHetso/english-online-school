<template>
  <div class="p-4">
    <form @submit.prevent="submitEdit(props.intensiveId)" class="space-y-4 text-white bg-purple-100 p-4 rounded-lg">
      <div>
